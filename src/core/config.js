...
export const LOCKING_SYSTEMS = Object.freeze([
  Object.freeze({
    ...
    key: 'none',
    name: 'sem travamento',
    description: 'Uma porca sem bloqueio adicional. A vibração pode reduzir a pré-carga e fazê-la caminhar na rosca.',
    resistance: 0
  }),
  Object.freeze({
    id: 1,
    key: 'double-nut',
    name: 'contra-porca',
    description: 'Duas porcas apertadas em oposição. Resiste por pré-carga e atrito, mas não é um bloqueio positivo.',
    resistance: 0.55
  }),
  Object.freeze({
    id: 2,
    ...
    description: 'Par de anilhas com rampas. A tentativa de desaperto força a subida das cunhas e aumenta a tensão.',
    resistance: 0.82
  }),
  Object.freeze({
    id: 3,
    ...
    description: 'Patilha dobrada sobre uma face da porca. A rotação fica limitada por contacto mecânico.',
    resistance: 0.94
  }),
  Object.freeze({
    id: 4,
    ...
    description: 'Porca castelo atravessada por cavilha. A porca não consegue avançar ao longo da rosca.',
    resistance: 0.995
  })
]);
